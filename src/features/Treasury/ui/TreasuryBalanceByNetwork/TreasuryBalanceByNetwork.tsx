...
import {
  mapBalanceByNetworkTableData,
  TreasuryBalanceByNetworkChart,
  treasuryBalanceByNetworkColumns,
  TreasuryBalanceByNetworkProps,
  TreasuryBalanceByNetworkTable,
  TreasuryBalanceByNetworkType
} from '@/entities/Treasury';
import { useModal } from '@/shared/hooks';
import { colorPicker, extractFilterOptions } from '@/shared/lib/utils';
import { OptionType } from '@/shared/types';
import { Button, Icon, View } from '@/shared/ui/atoms';
import { Card, NoDataPlaceholder } from '@/shared/ui/molecules';
import { Filter, MultiSelect, SortDrawer } from '@/shared/ui/organisms';
...
const TreasuryBalanceByNetwork = ({
  ...
  const tableData = useMemo<TreasuryBalanceByNetworkType[]>(() => {
    ...
    return mapBalanceByNetworkTableData(filtered).sort(
      (a, b) => b.value - a.value
    );
...
export { TreasuryBalanceByNetwork };
