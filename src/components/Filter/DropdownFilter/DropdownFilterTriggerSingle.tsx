...
export const DropdownFilterTriggerSingle = (props: DropdownFilterTriggerProps) => {
  ...
  return (
    ...
    >
      {hasSelectedOptions
        ? <div className={'flex h-4 px-2.5 items-center justify-center rounded-sm bg-secondary-46'}>
          <Text size='11' weight='500' className='text-primary-18'>
            {prefix}
          </Text>
        </div>
      ...
      <Text size='11' weight='500' className={'!text-gray-11'}>
        {label}
      </Text>
    </button>
  );
