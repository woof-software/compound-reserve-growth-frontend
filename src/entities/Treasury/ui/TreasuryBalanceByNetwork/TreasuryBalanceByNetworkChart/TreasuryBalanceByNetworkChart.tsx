...
interface TreasuryBalanceByNetworkChartProps {
  data: ChartData[];

  onClear: () => void;
}

const TreasuryBalanceByNetworkChart: FC<TreasuryBalanceByNetworkChartProps> = ({
  data,
  onClear
}) => {
...
export { TreasuryBalanceByNetworkChart };
