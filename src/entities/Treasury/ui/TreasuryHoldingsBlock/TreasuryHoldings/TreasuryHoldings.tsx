...
import { TreasuryHoldingType } from '@/entities/Treasury';
import { cn } from '@/shared/lib/classNames';
import { formatLargeNumber, formatPrice } from '@/shared/lib/utils';
...
export interface TreasuryHoldingsProps {
  tableData: TreasuryHoldingType[];

  sortType: { key: string; type: string };
}

const treasuryColumns: ExtendedColumnDef<TreasuryHoldingType>[] = [
  {
    id: 'symbol',
...
const TreasuryHoldings = ({ tableData, sortType }: TreasuryHoldingsProps) => {
  const mobileTableData = useMemo(() => {
    ...
    const key = sortType.key as keyof TreasuryHoldingType;
