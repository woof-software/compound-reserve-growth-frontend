...
import { LineChartSeries } from '@/shared/types';
...
interface TotalTreasuryValueLineChartProps {
...
const TotalTreasuryValueLineChart: FC<TotalTreasuryValueLineChartProps> = ({
  data,
  groupBy,
  chartRef,
  isLegendEnabled,
...
export { TotalTreasuryValueLineChart };
