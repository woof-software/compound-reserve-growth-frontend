...
const columns: ExtendedColumnDef<CurrentServiceProviderRow>[] = [
  {
...
const CurrentServiceProvidersTable: FC<CurrentServiceProvidersTableProps> = ({
  data,
  footerData,
  sortType
}) => {
  ...
  const mobileTableData = useMemo(() => {
    ...
    const key = sortType.key as keyof CurrentServiceProviderRow;
...
export { CurrentServiceProvidersTable };
