...
interface CurrentServiceProvidersPieDataItem {
  name: string;
  percent: number;
  value: string;
  color?: string;
...
interface CurrentServiceProvidersPieChartProps {
  data: CurrentServiceProvidersPieDataItem[];
...
const CurrentServiceProvidersPieChart: FC<
  CurrentServiceProvidersPieChartProps
> = ({ data, className }) => {
...
export { CurrentServiceProvidersPieChart };
