...
import { RevenueOverviewPieChartChartProps } from '@/entities/Revenue';
import { cn } from '@/shared/lib/classNames';
import { colorPicker } from '@/shared/lib/utils/utils';
import { Button, Each, Icon, Text, View } from '@/shared/ui/atoms';

const RevenueOverviewPieChart: FC<RevenueOverviewPieChartChartProps> = ({
  data,
  className
}) => {
...
export { RevenueOverviewPieChart };
