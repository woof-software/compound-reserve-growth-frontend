...
import { CompoundFeeReceivedChartProps } from '@/entities/Revenue';
...
const CompoundFeeReceivedChart: FC<CompoundFeeReceivedChartProps> = ({
  chartRef,
  groupBy,
  seriesData = [],
  aggregatedData = [],
...
export { CompoundFeeReceivedChart };
