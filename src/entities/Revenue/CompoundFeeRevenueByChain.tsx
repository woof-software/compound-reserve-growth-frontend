  ...
  return (
    ...
    >
      <div className='flex flex-wrap justify-end gap-3 px-6 py-3 md:px-10 lg:px-0'>
        ...
        <Button
          onClick={onSortOpen}
          className='bg-secondary-27 outline-secondary-18 text-gray-11 flex min-w-[130px] gap-1.5 rounded-lg p-2.5 text-[11px] leading-4 font-semibold outline-[0.25px] md:hidden'
        >
          <Icon
            name='sort-icon'
